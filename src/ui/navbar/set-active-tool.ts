...
export function getToolForObj(
  ...
  switch (obj?.name) {
    ...
    case ObjectName.ChangeImage:
      return [ToolName.CHANGE_IMAGE, ActiveToolOverlay.ChangeImage];
    case ObjectName.Add_Image:
      return [ToolName.ADD_IMAGE, ActiveToolOverlay.ActiveObject];
    case ObjectName.Crop:
      return [ToolName.CHANGE_IMAGE, ActiveToolOverlay.Crop];
    case ObjectName.Resize:
      return [ToolName.CHANGE_IMAGE, ActiveToolOverlay.Resize];
    default:
      return [null, null];
  }
}
